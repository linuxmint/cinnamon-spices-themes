...
LIGHTBG="#718062";
LOWTRANSLIGHTBG="rgba(113, 128, 98, 0.8)";
MODTRANSLIGHTBG="rgba(113, 128, 98, 0.6)";
HIGHTRANSLIGHTBG="rgba(113, 128, 98, 0.4)";
DARKBG="#444d3b";
LOWTRANSDARKBG="rgba(68, 77, 59, 0.8)";
MODTRANSDARKBG="rgba(68, 77, 59, 0.6)";
HIGHTRANSDARKBG="rgba(68, 77, 59, 0.4)";
cd "$DIRECTORY" || exit;
echo "";
