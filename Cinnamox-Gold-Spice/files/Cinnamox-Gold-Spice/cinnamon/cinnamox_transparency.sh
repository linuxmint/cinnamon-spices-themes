...
LIGHTBG="#99461e";
LOWTRANSLIGHTBG="rgba(153, 70, 30, 0.8)";
MODTRANSLIGHTBG="rgba(153, 70, 30, 0.65)";
HIGHTRANSLIGHTBG="rgba(153, 70, 30, 0.5)";
DARKBG="#382218";
LOWTRANSDARKBG="rgba(56, 34, 24, 0.9)";
MODTRANSDARKBG="rgba(56, 34, 24, 0.75)";
HIGHTRANSDARKBG="rgba(56, 34, 24, 0.6)";
cd "$DIRECTORY";
echo "";
