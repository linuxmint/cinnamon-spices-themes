...
LIGHTBG="#834122";
LOWTRANSLIGHTBG="rgba(131, 65, 34, 0.8)";
MODTRANSLIGHTBG="rgba(131, 65, 34, 0.6)";
HIGHTRANSLIGHTBG="rgba(131, 65, 34, 0.4)";
DARKBG="#4f2714";
LOWTRANSDARKBG="rgba(79, 39, 20, 0.8)";
MODTRANSDARKBG="rgba(79, 39, 20, 0.6)";
HIGHTRANSDARKBG="rgba(79, 39, 20, 0.4)";
cd "$DIRECTORY" || exit;
echo "";
