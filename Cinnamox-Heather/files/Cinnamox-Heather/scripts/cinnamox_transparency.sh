...
LIGHTBG="#cddbe4";
LOWTRANSLIGHTBG="rgba(205, 219, 228, 0.8)";
MODTRANSLIGHTBG="rgba(205, 219, 228, 0.6)";
HIGHTRANSLIGHTBG="rgba(205, 219, 228, 0.4)";
DARKBG="#5d89a8";
LOWTRANSDARKBG="rgba(93, 137, 168, 0.8)";
MODTRANSDARKBG="rgba(93, 137, 168, 0.6)";
HIGHTRANSDARKBG="rgba(93, 137, 168, 0.4)";
cd "$DIRECTORY" || exit;
echo "";
