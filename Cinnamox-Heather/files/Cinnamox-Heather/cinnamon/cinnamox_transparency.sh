...
LIGHTBG="#b7c4cc";
LOWTRANSLIGHTBG="rgba(183, 196, 204, 0.8)";
MODTRANSLIGHTBG="rgba(183, 196, 204, 0.65)";
HIGHTRANSLIGHTBG="rgba(183, 196, 204, 0.5)";
DARKBG="#72a0bf";
LOWTRANSDARKBG="rgba(114, 160, 191, 0.9)";
MODTRANSDARKBG="rgba(114, 160, 191, 0.75)";
HIGHTRANSDARKBG="rgba(114, 160, 191, 0.6)";
cd "$DIRECTORY";
echo "";
