...
`chmod +x ~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_fontsize.sh && ~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_fontsize.sh`

If you are not happy with the end result simply run `~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_fontsize.sh` again to chose another option including the default
...
`chmod +x ~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_toggle_cinnamon.sh && ~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_toggle_cinnamon.sh`

To revert to the new styling simply run `~/.themes/Cinnamox-Kashmir-Blue/cinnamon/cinnamox_toggle_cinnamon.sh` again.
