...
`chmod +x ~/.themes/Cinnamox-Rhino/cinnamon/cinnamox_fontsize.sh && ~/.themes/Cinnamox-Rhino/cinnamon/cinnamox_fontsize.sh`

If you are not happy with the end result simply run `~/.themes/Cinnamox-Rhino/cinnamon/cinnamox_fontsize.sh` again to chose another option including the default
