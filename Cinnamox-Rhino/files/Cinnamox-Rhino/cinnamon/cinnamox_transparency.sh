...
LIGHTBG="#434e5a";
LOWTRANSLIGHTBG="rgba(67, 78, 90, 0.8)";
MODTRANSLIGHTBG="rgba(67, 78, 90, 0.65)";
HIGHTRANSLIGHTBG="rgba(67, 78, 90, 0.5)";
DARKBG="#1c2126";
LOWTRANSDARKBG="rgba(28, 33, 38, 0.9)";
MODTRANSDARKBG="rgba(28, 33, 38, 0.75)";
HIGHTRANSDARKBG="rgba(28, 33, 38, 0.6)";
cd "$DIRECTORY";
echo "";
