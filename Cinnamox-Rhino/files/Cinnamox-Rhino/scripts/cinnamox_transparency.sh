...
LIGHTBG="#3c4650";
LOWTRANSLIGHTBG="rgba(60, 70, 80, 0.8)";
MODTRANSLIGHTBG="rgba(60, 70, 80, 0.6)";
HIGHTRANSLIGHTBG="rgba(60, 70, 80, 0.4)";
DARKBG="#242a30";
LOWTRANSDARKBG="rgba(36, 42, 48, 0.8)";
MODTRANSDARKBG="rgba(36, 42, 48, 0.6)";
HIGHTRANSDARKBG="rgba(36, 42, 48, 0.4)";
cd "$DIRECTORY" || exit;
echo "";
