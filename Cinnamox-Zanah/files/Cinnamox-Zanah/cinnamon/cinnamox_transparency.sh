...
LIGHTBG="#cde4cf";
LOWTRANSLIGHTBG="rgba(205, 228, 207, 0.8)";
MODTRANSLIGHTBG="rgba(205, 228, 207, 0.6)";
HIGHTRANSLIGHTBG="rgba(205, 228, 207, 0.4)";
DARKBG="#5da863";
LOWTRANSDARKBG="rgba(93, 168, 99, 0.8)";
MODTRANSDARKBG="rgba(93, 168, 99, 0.6)";
HIGHTRANSDARKBG="rgba(93, 168, 99, 0.4)";
cd "$DIRECTORY";
echo "";
