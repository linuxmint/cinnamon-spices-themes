...
LIGHTBG="#af0000";
LOWTRANSLIGHTBG="rgba(175, 0, 0, 0.8)";
MODTRANSLIGHTBG="rgba(175, 0, 0, 0.6)";
HIGHTRANSLIGHTBG="rgba(175, 0, 0, 0.4)";
DARKBG="#690000";
LOWTRANSDARKBG="rgba(105, 0, 0, 0.8)";
MODTRANSDARKBG="rgba(105, 0, 0, 0.6)";
HIGHTRANSDARKBG="rgba(105, 0, 0, 0.4)";
cd "$DIRECTORY" || exit;
echo "";
