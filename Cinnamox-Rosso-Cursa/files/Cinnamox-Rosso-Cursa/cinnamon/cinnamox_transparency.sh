...
LIGHTBG="#cc0000";
LOWTRANSLIGHTBG="rgba(204, 0, 0, 0.8)";
MODTRANSLIGHTBG="rgba(204, 0, 0, 0.65)";
HIGHTRANSLIGHTBG="rgba(204, 0, 0, 0.5)";
DARKBG="#4c0000";
LOWTRANSDARKBG="rgba(76, 0, 0, 0.9)";
MODTRANSDARKBG="rgba(76, 0, 0, 0.75)";
HIGHTRANSDARKBG="rgba(76, 0, 0, 0.6)";
cd "$DIRECTORY";
echo "";
